...
namespace xla {
/*
    A pass that attempts to rematerialize large SPMD partitioner inserted tensor
   ...
   The pass also assumes the opt-barrier for activation checkpointing is already
   present by Jax.
